...
public class WidgetViewsFactoryStandard implements RemoteViewsService.RemoteViewsFactory {
    ...
    public WidgetViewsFactoryStandard(Context context, Intent intent) {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_item_standard);

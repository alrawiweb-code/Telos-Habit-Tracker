...
public class WidgetViewsFactoryDark implements RemoteViewsService.RemoteViewsFactory {
    ...
    public WidgetViewsFactoryDark(Context context, Intent intent) {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_item_dark);
        ...
        if (item.completed) {
            // Completed: dark green pill bg, dark green icon circle, show checkmark
            ...
            // Incomplete: default dark pill bg, default icon circle, hide checkmark
